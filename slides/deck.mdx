...
Link to GitHub: https://github.com/raphsutti/web-session-security
```
...
<img src={require("file-loader!./images/goat.gif")} />
...
Defend against this with Sanitise/validate your input
